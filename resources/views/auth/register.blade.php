        ...
        <div class="login-form">
            ...
            <div class="sign-up-htm">
                ...
                <div class="group">
                    ...
                    <input id="pass" type="text" class="input" name="email" value="{{ old('email') ?? '' }}">
                    <div><p class="text-error">{{ $errors->first('email') }}</p></div>
                </div>
                <div class="group">
                ...
                <div class="group">
                    ...
                    <input id="pass" type="password" class="input" data-type="password" name="password_confirm">
                    <div><p class="text-error">{{ $errors->first('password_confirm') }}</p></div>
                </div>
                <div class="group">
